...
\noindent
 ...
 \hyphenpenalty=10000\uppercase\expandafter{}  \textbf{A} \hspace{0.2pt} \textbf{N}  \hspace{0.2pt} \textbf{E} \hspace{0.2pt}  \textbf{X} \hspace{0.2pt}   \textbf{0} \hspace{8.5pt}    \textbf{III}  \\
 \vspace*{-0.5cm} 
 --------------------------------------\\
\end{flushright} 
