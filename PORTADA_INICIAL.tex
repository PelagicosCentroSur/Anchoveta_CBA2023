    ...
    \vspace{5mm}
       \begin{minipage}{\textwidth}
        \parbox[t]{0.9\linewidth}{
            ...
            \vspace*{9.3cm} 
            \hfill \textbf{SEGUNDO INFORME TÉCNICO}
            ...
            Estatus y Posibilidades de Explotación Biológicamente \\ Sustentables de Anchoveta,  Región de Valparaíso \\ a la Región de Los Lagos, año 2023
			\end{flushright} 
              
			\centering \fontsize{10pt}{8pt}\selectfont
            \vspace*{2mm} 
            \hfill \textbf{SUBSECRETARIA DE ECONOMIA Y EMT / Marzo 2023}
...
\centering \fontsize{9pt}{8pt}\selectfont
            ...
            Sustentables de Anchoveta,  Región de Valparaíso \\ 
