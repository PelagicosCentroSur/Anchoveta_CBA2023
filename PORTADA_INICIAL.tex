    ...
    \vspace{5mm}
       \begin{minipage}{\textwidth}
        \parbox[t]{0.9\linewidth}{
            ...
            Estatus y Posibilidades de Explotación Biológicamente \\ Sustentable de Anchoveta,  Región de Valparaíso \\ a la Región de Los Lagos, año 2023
			\end{flushright} 
...
\centering \fontsize{9pt}{8pt}\selectfont
            ...
            Sustentable de Anchoveta,  Región de Valparaíso \\ 
